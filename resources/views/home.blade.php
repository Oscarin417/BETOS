                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-c-pink order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i class="fas fa-dollar-sign f-left"></i><span>{{$cant_productos}}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/productos" class="text-white">Ver mas</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
